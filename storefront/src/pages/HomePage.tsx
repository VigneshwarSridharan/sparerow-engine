...
import heroImage from "@/assets/hero/phone-parts-hero.png";
...
import {
  fetchStorefrontHomeFilters,
  fetchStorefrontProductSections,
...
export default function HomePage() {
  ...
  const { data: productSections, isLoading: isProductSectionsLoading } =
    useQuery({
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="max-w-2xl">
              ...
              <p className="text-lg text-muted-foreground mt-4 max-w-lg">
                Find genuine spare parts for Apple, Samsung, Xiaomi and more.
                Fast shipping, warranty support, and curated quality.
              </p>
            ...
            <div className="relative hidden md:flex items-center justify-center h-80">
              ...
              {/* <img
                src={heroImage}
                alt="Exploded view of mobile phone spare parts"
