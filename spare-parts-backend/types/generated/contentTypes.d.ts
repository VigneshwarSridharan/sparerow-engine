...
export interface ApiCmsBlockCmsBlock extends Struct.CollectionTypeSchema {
  collectionName: 'cms_blocks';
  info: {
    displayName: 'CMS Block';
    pluralName: 'cms-blocks';
    singularName: 'cms-block';
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiCommerceSingletonPlaceholder
  extends Struct.SingleTypeSchema {
  collectionName: 'commerce_singleton_placeholders';
  info: {
    displayName: 'Internal (commerce routing)';
    pluralName: 'singleton-placeholders';
    singularName: 'singleton-placeholder';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::commerce.singleton-placeholder'
    > &
      Schema.Attribute.Private;
    note: Schema.Attribute.String & Schema.Attribute.DefaultTo<'reserved'>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiCustomerAccountCustomerAccount
  extends Struct.CollectionTypeSchema {
  collectionName: 'customer_accounts';
  info: {
...
export interface ApiOrderLineItemOrderLineItem
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    lineTotalInMinor: Schema.Attribute.BigInteger & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::order-line-item.order-line-item'
    > &
      Schema.Attribute.Private;
    ...
    skuSnapshot: Schema.Attribute.String & Schema.Attribute.Required;
    unitPriceInMinor: Schema.Attribute.BigInteger & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    shippingCity: Schema.Attribute.String & Schema.Attribute.Required;
    shippingCountryCode: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'IN'>;
    shippingInMinor: Schema.Attribute.BigInteger &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'0'>;
    shippingLine1: Schema.Attribute.String & Schema.Attribute.Required;
    shippingLine2: Schema.Attribute.String;
    shippingPhone: Schema.Attribute.String & Schema.Attribute.Required;
    shippingPostalCode: Schema.Attribute.String & Schema.Attribute.Required;
    shippingRecipientName: Schema.Attribute.String & Schema.Attribute.Required;
    shippingState: Schema.Attribute.String & Schema.Attribute.Required;
    ...
    subtotalInMinor: Schema.Attribute.BigInteger & Schema.Attribute.Required;
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String & Schema.Attribute.Required;
    partCategory: Schema.Attribute.Relation<
      'manyToOne',
      'api::part-category.part-category'
    >;
    partModel: Schema.Attribute.Relation<
      'manyToOne',
      'api::part-model.part-model'
    >;
    ...
    quantityOnHand: Schema.Attribute.Integer &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<0>;
    quantityReserved: Schema.Attribute.Integer &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<0>;
...
export interface ApiShipmentShipment extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    carrier: Schema.Attribute.Enumeration<['MOCK', 'SHIPROCKET', 'DELHIVERY']> &
      Schema.Attribute.Required;
    carrierMetadata: Schema.Attribute.JSON;
    carrierShipmentRef: Schema.Attribute.String;
    carrierStatusLabel: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    lastAdminMessage: Schema.Attribute.Text;
...
export interface ApiWebhookDeliveryWebhookDelivery
  ...
  info: {
    ...
    pluralName: 'webhook-deliveries';
    singularName: 'webhook-delivery';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::webhook-delivery.webhook-delivery'
    > &
      Schema.Attribute.Private;
    payloadHash: Schema.Attribute.String & Schema.Attribute.Required;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::cms-block.cms-block': ApiCmsBlockCmsBlock;
