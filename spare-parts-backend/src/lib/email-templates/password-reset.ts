    ...
    <tr><td align="center">
      <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:8px;overflow:hidden;max-width:600px;">
        ...
        <tr><td style="padding:32px;">
          ...
          <p style="margin:0 0 24px;color:#555;">We received a request to reset the password for your SpareHub account. Click the button below to choose a new password. This link expires in 1 hour.</p>
